...
import alitrtcflutte.sophon.utils.ApplicationContextUtil;
import alitrtcflutte.sophon.utils.ThreadUtils;
...
public class RTCBeaconTowerImpl extends BaseRTCBeaconTower {
    ...
    public void init() {
        if (mAliRtcEngine == null) {
            ...
            Log.e("兼容H5", String.valueOf(mAliRtcEngine.getH5CompatibleMode()));
    ...
    public int muteLocalCamera(boolean isMute) {
        if (mAliRtcEngine != null) {
            return mAliRtcEngine.muteLocalCamera(isMute, AliRtcVideoTrackCamera);
        }
        return -1;
    }
